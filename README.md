...
COMPRESSION:
 ...
 image if the width and/or height are odd. If they are odd, it will map over
 ...
 the new "pixels" for our Pnm_ppm and is passed back into our compress40.c. 
 Then compress40 calls on our second file: float.c. In this file, the program 
 ...
 Pnm_ppm is passed back to compress40.c. Finally, compress40 calls on our third 
