 ...
 *     Date:     3/6/24
 *
 *     Implementation of our codewords. Here are all of the member functions.
 *     codewords.c works primarily on variables that use 32-bit words. 
 *     Facilitates conversion between 6 comp vid and codewords. We call on 
 *     Bitpack to help with these conversions.
 *
 *************************************************************************/
#include "codewords.h"
#include "a2methods.h"
