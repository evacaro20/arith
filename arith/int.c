 ...
 *     Date:     3/6/24
 *
 *     Implementation of our int.c. Here are all of the member functions of
 *     int. int.c works primarily on variables that use ints. Facilitates 
 *     conversion between RBGs and component video arrays.
 *
 *************************************************************************/
#include "int.h"
#include "a2methods.h"
